...
import ClassWarriorMale from '../../Assets/Class_WarriorMale.png'
import ClassWarriorFemale from '../../Assets/Class_WarriorFemale.png'
import { useState } from 'react';

export default function PageClassWarrior() {
    ...
    <StyledContainer>
      <StyledClasses>
          ...
          <div className="content_class_image">
            {
              gender
              ?
              <img src={ClassWarriorFemale} onClick={changeImg}/>
              :
              <img src={ClassWarriorMale} onClick={changeImg}/>
            }
          </div>
        ...
        <div className='content_right'>
          <div>
            <p className='content_class_title'> <spam style={{color: "red"}}>o</spam>) CLASSE </p>
